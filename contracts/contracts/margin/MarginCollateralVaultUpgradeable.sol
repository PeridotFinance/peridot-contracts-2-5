...
contract MarginCollateralVaultUpgradeable is Initializable, OwnableUpgradeable {
    using SafeERC20 for IERC20;

    IAtomicMarginExecutorVault public executor;
    ...
    function initialize(address executor_, address owner_) external initializer {
        require(executor_ != address(0), "MarginVault: invalid executor");
        require(owner_ != address(0), "MarginVault: invalid owner");
