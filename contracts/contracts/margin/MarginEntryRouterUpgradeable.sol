...
contract MarginEntryRouterUpgradeable is Initializable, OwnableUpgradeable {
    IAtomicMarginExecutorEntry public executor;
    IMarginCollateralVaultEntry public collateralVault;
    ...
    function initialize(address executor_, address collateralVault_, address owner_) external initializer {
        require(executor_ != address(0), "EntryRouter: invalid executor");
        require(collateralVault_ != address(0), "EntryRouter: invalid vault");
        require(owner_ != address(0), "EntryRouter: invalid owner");
