...
contract AtomicMarginLiquidation is IERC3156FlashBorrower, ReentrancyGuard, Ownable {
    ...
    IAtomicMarginAccounts public immutable executor;
    IAtomicMarginConfigSource public immutable configSource;
    ...
    constructor(address executor_, address configSource_, address owner_) Ownable(owner_) {
