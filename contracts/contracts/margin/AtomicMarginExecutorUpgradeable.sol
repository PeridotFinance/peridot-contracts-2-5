...
contract AtomicMarginExecutorUpgradeable is
    Initializable,
    OwnableUpgradeable,
    ...
    IERC3156FlashBorrower
{
    ...
    SmartMarginAccount public implementation;
    IMarginConfigSource public configSource;
    ...
    function initialize(address owner_, address configSource_) external initializer {
        require(owner_ != address(0), "Executor: invalid owner");
