...
contract GovernorAlpha {
    ...
    string public constant name = "Peridot Governor Alpha";
    ...
    /// @notice The address of the Peridot Protocol Timelock
    TimelockInterface public timelock;

    /// @notice The address of the Peridot governance token
    PeridotInterface public peridot;
    ...
    constructor(address timelock_, address peridot_, address guardian_) {
        timelock = TimelockInterface(timelock_);
        peridot = PeridotInterface(peridot_);
        guardian = guardian_;
    }
    ...
    function propose(
        ...
        require(
            peridot.getPriorVotes(msg.sender, sub256(block.number, 1)) > proposalThreshold(),
    ...
    function cancel(uint256 proposalId) public {
        ...
        require(
            msg.sender == guardian
                || peridot.getPriorVotes(proposal.proposer, sub256(block.number, 1)) < proposalThreshold(),
    ...
    function _castVote(address voter, uint256 proposalId, bool support) internal {
        ...
        uint96 votes = peridot.getPriorVotes(voter, proposal.startBlock);
