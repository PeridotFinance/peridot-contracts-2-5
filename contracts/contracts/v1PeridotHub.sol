 ...
 */
contract PeridotHubHandler is AxelarExecutableWithToken {
    // --- Events ---
    ...
    function _execute(
        ...
        // Validate that the token is supported by Axelar
        address axelarTokenAddress = gatewayWithToken().tokenAddresses(tokenSymbol);
        require(axelarTokenAddress == underlying, "Token not supported by Axelar or address mismatch");
