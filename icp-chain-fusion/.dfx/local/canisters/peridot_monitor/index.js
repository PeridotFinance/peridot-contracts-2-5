...
import { idlFactory } from './peridot_monitor.did.js';
export { idlFactory } from './peridot_monitor.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PERIDOT_MONITOR;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./peridot_monitor.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the peridot_monitor canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./peridot_monitor.did.js")._SERVICE>}
 */
export const peridot_monitor = createActor(canisterId);
